...
/// key, mirroring the run stream's key semantics. PostgreSQL treats NULLs as
...
public sealed class EventIdempotencyKey : Migration
{
    protected override void Up(MigrationBuilder m) => m.Sql("""
        alter table event_index add column if not exists idempotency_key text null;
    ...
    protected override void Down(MigrationBuilder m) => m.Sql("""
        ...
        alter table event_index drop column if exists idempotency_key;
        """);
}
