...
public sealed class LifecycleDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        entity.Property(x => x.PermissionRequestId);
            ...
            entity.Property(x => x.WorkspaceSnapshotHash).HasMaxLength(128);
...
public sealed class ToolExecutionRecord { public Guid Id { get; set; } public Guid TenantId { get; set; } public Guid WorkspaceId { get; set; } public Guid? ProjectId { get; set; } public Guid SessionId { get; set; } public Guid RunId { get; set; } public Guid TaskId { get; set; } public Guid AgentInstanceId { get; set; } public Guid? ApprovalId { get; set; } public Guid? PermissionRequestId { get; set; } public Guid? AuthorizationDecisionId { get; set; } public Guid? CapabilityLeaseId { get; set; } public Guid? WorkspaceSnapshotId { get; set; } public string? WorkspaceSnapshotHash { get; set; } public string ToolId { get; set; } = string.Empty; public string ToolCallKey { get; set; } = string.Empty; public string Risk { get; set; } = "low"; public bool MutatesWorkspace { get; set; } public bool RequiresApproval { get; set; } public int LeaseUses { get; set; } = 1; public string Status { get; set; } = "requested"; public string? LaneKey { get; set; } public string ParametersHash { get; set; } = string.Empty; public string ParametersReference { get; set; } = string.Empty; public long ParametersLength { get; set; } public string? ResultReference { get; set; } public string? ResultHash { get; set; } public long? ResultLength { get; set; } public string? ErrorCategory { get; set; } public string? SafeErrorMessage { get; set; } public bool? ToolSuccess { get; set; } public int Attempt { get; set; } = 1; public DateTimeOffset CreatedAt { get; set; } public DateTimeOffset UpdatedAt { get; set; } public DateTimeOffset? CompletedAt { get; set; } }
