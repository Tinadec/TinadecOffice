...
**Last Updated By:** Claude (added WorkbenchShell layout engine to Desktop: deterministic 3-slot layout authority, card registry, command bus with undo, constraint solver, layer-scoped layout persistence to userData/workbench-layout.json, Vue 3.6 Vapor per-SFC enablement)
**Last Verified Commit:** f8d16a6
**Branch:** UI/StillREd
