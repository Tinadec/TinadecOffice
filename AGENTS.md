...
**Last Updated By:** OpenCode (Reusable Desktop notification dialogs)
**Last Verified Commit:** d0d1dd462da83a14185c88c5101d2da79884c77d
**Branch:** main
...
| Desktop notifications | `apps/desktop/src/composables/useNotifications.ts`, `NotificationIslandHost.vue`, `NotificationDetailDialog.vue`, `App.vue` | Stable dynamic-island capsules open a hover/click card and reusable glass detail/confirm dialog. Persistent status is source-cleared, not UI-dismissed; never replaces Core approvals or chat approval UI. |
