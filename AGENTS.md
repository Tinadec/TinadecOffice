...
**Last Updated By:** OpenCode (Desktop route transition clipping)
**Last Verified Commit:** ddde4bf45be85d093feaa213b0b65e1839c238dd
**Branch:** main
...
| Desktop notifications | `apps/desktop/src/composables/useNotifications.ts`, `src/components/NotificationIslandHost.vue`, `src/components/ConfirmationDialog.vue`, `src/App.vue` | Window-local notification islands, persistent banners, and FIFO confirmations; never replaces Core approvals or contextual errors. |
