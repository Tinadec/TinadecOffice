...
**Last Updated By:** Claude (added proactive vue-mcp Desktop UI introspection guidance; install now works via root `.npmrc` legacy-peer-deps + explicit react deps)
**Last Verified Commit:** 8706697
**Branch:** main
