...
**Last Updated By:** opencode (剩余缺口收口：Session迁移幂等 + 工具交集run冻结复算 + Prompt template/assemble双必备 + 模型策略拓扑继承/control_event_index审计 + SSE 8+5扩展；Core 68/Gateway 35 green)
