...
**Last Updated By:** opencode (review-fix batch: SSE watermark follow, session GET-by-id fallback, hardcoded MCP key removed from .mcp.json/opencode.jsonc, 412 conflict dialog in Settings agent writes, /agent-center redirect)
