...
**Last Updated By:** Muse Spark (config-chain repair: merge-on-update provider config, secret-store-only keys, provider_in_use guard + force, mandatory If-Match, legacy NOT NULL column drop; live real-model chain verified)
**Last Verified Commit:** 4aba27f
**Branch:** main
