...
**Last Updated By:** opencode (CLI runtime connect closed loop: discover→connect→provider, Desktop quick-connect + Gateway proxy; Core Api 68/Gateway 37 green; Desktop 239/253)
