...
**Last Updated By:** OpenCode (Desktop Dynamic Island notifications)
...
| Desktop notifications | `apps/desktop/src/composables/useNotifications.ts`, `NotificationIslandHost.vue`, `NotificationDetailDialog.vue`, `App.vue` | Dynamic-island capsules (hover peek, click detail/confirm); system errors/connection use islands; never replaces Core approvals or chat approval UI. |
