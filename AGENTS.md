...
**Last Updated By:** Qoder (shell tool result wire format is snake_case again — terminal session registry/stdio/kill unblocked; shell vs shell.execute id mismatch still open)
**Last Verified Commit:** 82b7135
**Branch:** main
