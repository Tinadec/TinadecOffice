...
**Last Updated:** 2026-09-12（Phase 1.5）
**Last Updated By:** DmaEA 图编排 Phase 1 + 1.5：Phase 1（新表 5 张 + ConversationIdentity + 检查器闸2/闸3 + 包 v1 原地演进 + 真图投影 + 唤醒 pinning + 契约再生）；Phase 1.5（GraphModeResolver 双写 + 确定性/自派发档派发器 + vibe 随 run E2E + 冻结配置 Graph 段）
