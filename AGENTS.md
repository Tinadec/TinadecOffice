...
**Last Updated By:** Codex (Settings interiors now use surface tiers and spacing instead of neutral decorative separators; blur roots expose bounded section/raised filters; spec in `docs/architecture.md` § Desktop Panel Material System)
**Last Verified Commit:** 962420a
**Branch:** main
