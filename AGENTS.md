...
**Last Updated By:** Claude (implemented the DmaEA dual-layer runtime: invoke-stream SSE, planning/execution agents over IChatResolver, DevSeed chat-route bootstrap, orchestration/tool-executions/task-nodes projections)
