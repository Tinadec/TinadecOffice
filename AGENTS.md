...
**Last Updated By:** Claude (formalized the desktop layout engine as TinadecUI / TinadecUIE under apps/TinadecUI; engine renamed Workbench* → Uie*, consumed via '@tinadec/ui' alias in desktop + web)
