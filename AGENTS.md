...
**Last Updated By:** Codex (Git integration tools)
**Last Verified Commit:** 2e97866
**Branch:** main
...
- `executor_git_manager` is the execution-layer Git Manager Subagent. It may explain branch/status/diff/worktree/push readiness; all Git mutations except conflict resolution execute through approved TinadecTools calls, while conflict resolution stays approval-gated through `git_worktree_manager` until migrated.
