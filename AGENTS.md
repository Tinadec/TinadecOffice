...
| Harness manifest / tool discovery / runtime readiness | `src/TinadecCore/Services/HarnessManifestService.cs`, `src/TinadecCore/Services/ToolSearchService.cs`, `src/TinadecCore/Services/RuntimeReadinessService.cs`, `src/TinadecCore/Services/ModelReadinessService.cs`, `src/TinadecCore/Contracts/Models/CoreDtos.cs` | Core-owned summary, searchable discovery, runtime/model readiness receipts, dual agent layers, Tool-layer providers, risk policy, and tool descriptors. |
