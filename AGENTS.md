...
**Last Updated By:** CatPaw (Desktop notification module: formal dismissal/persistence contract on the Apple Live Activity + 小米超级岛 model; overflow panel is now a notification center with live + cleared sections; see `apps/desktop/src/composables/useNotifications.ts`)
**Last Verified Commit:** 936cab5
**Branch:** main
