...
**Last Updated By:** Codex (Desktop global panel material settings now persist synchronously in a module-lifetime storage scope with normalized values; see `apps/desktop/src/composables/usePanelStyles.ts`)
**Last Verified Commit:** 4367ec5
**Branch:** main
...
| `usePanelStyles` | Composable | `apps/desktop/src/composables/usePanelStyles.ts` | Synchronously persists normalized global panel material settings in a detached module-lifetime storage scope. |
