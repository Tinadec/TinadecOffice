...
**Last Updated By:** Qoder (feature-panel terminal: reactive-Proxy IPC root cause, PTY-only backend, loud failure)
**Last Verified Commit:** 4c3a613
**Branch:** main
...
3. `docs/architecture.md` - current technical architecture, ports, event shape, and Debug Studio overview.
