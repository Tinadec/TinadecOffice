...
**Last Updated By:** DmaEA 图编排 Phase 1（权限包络驱动图编排第一刀）：新表 5 张 + ConversationIdentity + 检查器闸2/闸3 + 包 v1 原地演进（tools/bindings/relationship + graph_mode_packs capability 门）+ 真图投影 + 唤醒 pinning + 契约三件套再生
**Last Verified Commit:** b9c75fc
**Branch:** Astra
