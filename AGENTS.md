...
**Last Updated By:** Muse Spark (desktop unified persistent composer: one ComposerBar across hero/docked with FLIP sink, welcome-dialog-owned box styling, space-flipping teleported popovers, pendingEcho no-flicker reload; SessionModeStrip merged INTO the single ModeSelector dropdown (follow-default + published versions); live-verified over real Gateway+Core)
**Last Verified Commit:** 9152972
**Branch:** main
