...
export default defineSettingsModule('SettingsAgentsModule')
</script>

<template>
<div class="settings-module" data-settings-module="agents">
          ...
          <section class="center-overview-receipt agent-overview-receipt" :aria-label="t('settings.centerOverview')">
            ...
            <div class="center-receipt-item configured">
              ...
              <div>
                ...
                <strong>{{ agents.filter((agent: any) => agent.enabled).length }} / {{ agents.length }}</strong>
              </div>
