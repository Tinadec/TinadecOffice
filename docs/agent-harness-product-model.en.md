...
## Implementation Status (2026-08-18 snapshot; M1–M8 not backfilled)

> This section is a 2026-08-18 snapshot. Later M1–M8 records (lane scheduling and gates, approval windows, auto-approve, unattended lanes) are maintained only in `AGENTS.md` and `docs/tinadec-core-product-definition.zh-CN.md` §6.4.1; where they conflict, those two and the source code win.
