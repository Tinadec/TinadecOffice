...
| N:app.officePack | Office Agent Pack v0.2.4 | L2 | high | `apps/desktop/src/agentPacks/OfficeAgentPack/manifest.json`，digest `e99cd567…f2e9`，14 Agent + 5 prompt pipelines + 7 Mode，治理角色 `tool_scope: []`（`AGENTS.md` 2026-08-25/26/31 与 2026-09-03 条目；2026-09-10 版本号由 0.2.3 修正为 0.2.4 以与已发布的 `create_workspace` 授权字节一致） |
