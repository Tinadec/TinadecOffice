...
| N:app.officePack | Office Agent Pack v0.2.0 | L2 | high | `apps/desktop/src/agentPacks/office/agent-pack.json`，digest `837497ea…7ee5`，14 Agent + 7 Mode（`AGENTS.md` 2026-08-25/26 条目） |
