...
### 4.1 UieStack.vue (Parent Container)
...
### 4.3 UieCardFrame.vue (Card Shell)
...
| 文件 | 作用 |
|------|------|
| `apps/TinadecUI/src/components/UieStack.vue` | 柱容器样式定义 |
| `apps/TinadecUI/src/components/UieCardFrame.vue` | 卡片外壳样式 |
| `apps/TinadecUI/src/components/uie-card-fill.css` | 内容填充覆盖规则 |
